...
## 做正确的事
之前我们只讨论了系统没有讨论一个重要话题，隐私。

### 预测性分析
在重视人权的社会中，一个人在被证明有罪前都受到保护。而在预测性分析系统中，没有任何犯罪行为的人则可能受到不公正的待遇。

####　偏见与歧视
如果给系统的数据带有偏见，则产生的预测也会受到影响。虽然我们可以显示的去掉一些带有偏见性的用户特征。但是另一些隐式特征比如住所等等往往会出卖他们。数据与模型是工具，不是主人。

#### 责任与义务
数据与算法的错误，在法律上很难做出责任判定。数据来自统计，而通过统计预测的个体与个体存在明显差异。我们需要让算法更负责更透明，要防止偏见被加强，要让错误能够得到矫正。否则它可能会带来危险的后果。

#### 反馈环
推荐系统中存在一些反馈环，会加强用户的喜好形成类似回音的系统。

### 隐私和追踪
除了使用数据进行有偏见的预测，另一个问题在于收集数据本身。

#### 监视
数据本身就是一种监视，数据过度收集可能导致我们生活在一个完全监控的世界中。虽然很多人觉得自己没有任何需要隐藏的。但是很多其他人就不一定那么幸运了。

#### 允许和选择的自由
用户很多时候不知道我们到底收集了很多数据而同意了服务许可。而且很多人没有同意就因为周围人的同意而被动的被收集了数据。还有可能用户被一些大的服务商绑架而别无选择。

#### 隐私和数据使用
隐私并不是让一切都称为秘密，而是让我们拥有选择哪些东西可以让哪些人看的自由。收集数据的公司则自行决定用户的数据哪些可以见人。用户可以选择哪些数据可以让别人看见是隐私保护的一个好的开始。

#### 数据是价值是力量
数据被当做提供服务的筹码交给机构，它是有价值的，而且是有毒的，因为它可能泄露，被敌对势力或者未来可能的集权政府使用。

#### 回想工业革命
和工业革命时一样，信息革命的初期也会有这种那样的问题。

#### 法律和自我规范
虽然有很多保护隐私的法规被通过，但是他们的效果在快速发展的时代存疑。这时候更多的需要观念上的转变，对用户数据存着敬意，而不是仅仅将其当做一串数字。
